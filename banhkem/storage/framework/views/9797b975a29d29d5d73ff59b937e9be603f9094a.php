                        ...
                        <tbody>
                            <?php $__currentLoopData = $bills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX" align="center">
                                    ...
                                    <?php endif; ?>
                                    <td class="center"><a href="admin/bills/delete/<?php echo e($bill->id); ?>"><i class="fa fa-trash-o  fa-fw"></i>Ẩn</a></td>
                                    <td class="center"><a href="admin/bills/edit/<?php echo e($bill->id); ?>"><i class="fa fa-pencil fa-fw"></i>Sửa</a></td>
