			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 119 Ông Ích Đường - Khuê Trung - Cẩm Lệ - Đà Nẵng</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 01283 327 061</a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						<?php if(Auth::check()): ?>
							<li><a href=""><?php echo e(Auth::user()->full_name); ?></a></li>
