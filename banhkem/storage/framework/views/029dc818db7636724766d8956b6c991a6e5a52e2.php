				...
				<div class="beta-products-list">
					...
					<div class="row">
						...
						<div class="single-item">
									...
									<?php endif; ?>
									<div class="single-item-header">
										<a href="<?php echo e(route('chitietsanpham',$sptt->id)); ?>"><img src="source/image/product/<?php echo e($sptt->image); ?>" alt="" height="230px"></a>
									</div>
									<div class="single-item-body">
										...
										<p class="single-item-price">
											...
											<?php else: ?>
												...
												<span class="flash-sale"><?php echo e(number_format($sptt->unit_price - ($sptt->unit_price *10/100))); ?> đ</span>
											<?php endif; ?>
										</p>
									</div>
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="<?php echo e(route('themgiohang',$sptt->id)); ?>"><i class="fa fa-shopping-cart"></i></a>
										<a class="beta-btn primary" href="<?php echo e(route('chitietsanpham',$sptt->id)); ?>">Chi tiết <i class="fa fa-chevron-right"></i></a>
										<div class="clearfix"></div>
									</div>
								</div>
							</div>
