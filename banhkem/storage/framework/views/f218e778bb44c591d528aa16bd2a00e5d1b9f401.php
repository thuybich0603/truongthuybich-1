...
<div class="shopping-cart">
  ...
  <div class="product">
    ...
    <div class="product-quantity">
      ...
      <a href="<?php echo e(route('chitietdathang')); ?>"><button style="background-color:orange; border-collapse: collapse;color:white;border:none">Cập nhật</button></a>
    </div>
    ...
    <div class="product-line-price" style="color:red"><?php if($cart['item']['new']==0): ?>
													<?php echo e(number_format(($cart['item']['unit_price']-($cart['item']['unit_price']*0.1))*$cart['qty'])); ?>

												<?php else: ?>
													<?php echo e(number_format($cart['item']['unit_price']*$cart['qty'])); ?> 
												<?php endif; ?></div>
  </div>
