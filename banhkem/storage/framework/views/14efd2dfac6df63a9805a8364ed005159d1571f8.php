                        ...
                        <tbody>
                            <?php $__currentLoopData = $theloai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="odd gradeX" align="center">
                                    ...
                                    <?php if($tl->isShow): ?>
                                    <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="admin/productType/delete/<?php echo e($tl->id); ?>">Ẩn</a></td>
                                    <?php else: ?>
                                    <td class="center"><i class="fa fa-trash-o  fa-fw"></i><a href="admin/productType/show/<?php echo e($tl->id); ?>">Hiện</a></td>
                                    <?php endif; ?>
