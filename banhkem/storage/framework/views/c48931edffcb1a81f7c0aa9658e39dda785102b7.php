								...
								<div class="single-item">
									...
									<div class="single-item-body">
										...
										<p class="single-item-price">
											<?php if($sp->new!=0): ?>
												<span class="flash-sale"><?php echo e(number_format($sp->unit_price)); ?> đ</span>
											<?php else: ?>
												<span class="flash-del"><?php echo e(number_format($sp->unit_price)); ?> đ</span>
												<span class="flash-sale"><?php echo e(number_format($sp->unit_price - ($sp->unit_price *10/100))); ?> đ</span>
											<?php endif; ?>
										</p>
									</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								<div class="single-item">
									...
									<?php endif; ?>
									<div class="single-item-header">
										<a href="<?php echo e(route('chitietsanpham',$sp_k->id)); ?>"><img src="source/image/product/<?php echo e($sp_k->image); ?>" alt="" height="230px"></a>
									</div>
									<div class="single-item-body">
										<p class="single-item-title"><?php echo e($sp_k->name); ?></p>
										<p class="single-item-price">
											<?php if($sp_k->new!=0): ?>
												<span class="flash-sale"><?php echo e(number_format($sp_k->unit_price)); ?> đ</span>
											<?php else: ?>
												<span class="flash-del"><?php echo e(number_format($sp_k->unit_price)); ?> đ</span>
												<span class="flash-sale"><?php echo e(number_format($sp_k->unit_price - ($sp_k->unit_price *10/100))); ?> đ</span>
											<?php endif; ?>
										</p>
									</div>
										<div class="single-item-caption">
							...
							<div class="row" style="margin-top: 30px; margin-left: 200px"><?php echo e($sp_khac->links()); ?></div>
						</div> <!-- .beta-products-list -->
					</div>
