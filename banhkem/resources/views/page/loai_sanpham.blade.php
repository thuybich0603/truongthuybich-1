									...
									<div class="single-item-body">
										...
										<p class="single-item-price">
											...
											@else
												...
												<span class="flash-sale">{{number_format($sp->unit_price - ($sp->unit_price *10/100))}} đ</span>
											@endif
										</p>
									</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								<div class="single-item">
									...
									@endif
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$sp_k->id)}}"><img src="source/image/product/{{$sp_k->image}}" alt="" height="230px"></a>
									</div>
									<div class="single-item-body">
										...
										<p class="single-item-price">
											...
											@else
												...
												<span class="flash-sale">{{number_format($sp_k->unit_price - ($sp_k->unit_price *10/100))}} đ</span>
											@endif
										</p>
									</div>
										<div class="single-item-caption">
							...
							<div class="row" style="margin-top: 30px; margin-left: 200px">{{$sp_khac->links()}}</div>
						</div> <!-- .beta-products-list -->
					</div>
