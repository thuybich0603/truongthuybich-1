			...
			<div class="row">
				<div class="col-sm-12">
					<div class="beta-products-list">
						<h4 class="text-center text-uppercase font-weight-bold lead" style="color:black">SẢN PHẨM KHUYẾN MÃI</h4>
						<div class="beta-products-details">
							
							<div class="clearfix"></div>
							<hr class="hr_sp ">
								<p class="text-center title">Sản phẩm tốt nhất của chúng tôi - Niềm đam mê lớn đến từ thực phẩm</p>
								<p class="">Tìm thấy {{count($sanpham_khuyenmai)}} sản phẩm</p>
						</div>
							...
							<div class="col-sm-3">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$spkm->id)}}"><img src="source/image/product/{{$spkm->image}}" alt="" height="230px"></a>
									</div>
									<div class="single-item-body">
										...
										<p class="single-item-price">
											...
											@else
												...
												<span class="flash-sale">{{number_format($spkm->unit_price - ($spkm->unit_price *10/100))}} đ</span>
											@endif
										</p>
									</div>
						...
						<div class="row" style="margin-top: 30px; margin-left: 400px">{{$sanpham_khuyenmai->links()}}</div>
				...
				<div class="col-sm-12">
					<div class="beta-products-list">
						...
						<div class="beta-products-details">
							...
							<hr class="hr_sp ">
								<p class="text-center title">Sản phẩm tốt nhất của chúng tôi - Niềm đam mê lớn đến từ thực phẩm</p>
								<p class="">Tìm thấy {{count($new_product)}} sản phẩm</p>
						</div>
						<div class="row">
							...
							<div class="col-sm-3 mb-5">
								<div class="single-item">
									<div class="single-item-header">
										<a href="{{route('chitietsanpham',$new->id)}}"><img src="source/image/product/{{$new->image}}" alt="" style=" border-radius: 50%;"height="240px"></a>
									</div>
							...
							@endforeach
							<div class="row" style="margin-top: 10px; margin-left: 400px">{{$new_product->links()}}</div>
						</div>
...
<div class="container">
        <p class="lead font-weight-bold text-center" style="color:orange">DỊCH VỤ CHÍNH CHÚNG TÔI CUNG CẤP</p><hr class="hr_sp">
